...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        // OK (3): Set the click handler to open the DetailActivity for plant ID,
    ...
    // OK (2): Modify updatePlantWidgets and updateAppWidget to pass the plant ID as well as a boolean
