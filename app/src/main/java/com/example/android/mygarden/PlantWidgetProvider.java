...
/**
 * change min version in gradle or add anotation @TargetApi(Build.VERSION_CODES.JELLY_BEAN)
 * to use the >> .getAppWidgetOptions(appWidgetId); in updateAppWidget()
 */
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        // OK (5): Use getAppWidgetOptions to get widget width and use the appropriate RemoteView method
        // OK (6): Set the PendingIntent template in getGardenGridRemoteView to launch PlantDetailActivity
