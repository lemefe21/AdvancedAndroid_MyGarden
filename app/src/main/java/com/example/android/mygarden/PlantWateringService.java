...
public class PlantWateringService extends IntentService {
    ...
    // OK (3): Create a new action ACTION_UPDATE_PLANT_WIDGETS to handle updating widget UI and
    ...
    public static final String ACTION_UPDATE_PLANTS_WIDGET = "com.example.android.mygarden.action.update_plant_widget";
    ...
    private void handleActionUpdatePlantWidgets() {
        ...
        if(cursor != null && cursor.getCount() > 1) {
            ...
            int planType = cursor.getInt(planTypeIndex);

            cursor.close();

            imageRes = PlantUtils.getPlantImageRes(this, timeNow - createdAt, timeNow - wateredAt, planType);

        }

        AppWidgetManager widgetManager = AppWidgetManager.getInstance(this);
        int[] appWidgetIds = widgetManager.getAppWidgetIds(new ComponentName(this, PlantWidgetProvider.class));

        PlantWidgetProvider.updatePlantwidgets(this, widgetManager, imageRes, appWidgetIds);
