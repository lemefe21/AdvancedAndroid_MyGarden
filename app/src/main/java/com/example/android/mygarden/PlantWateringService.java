...
public class PlantWateringService extends IntentService {
    ...
    // OK (1): Change ACTION_WATER_PLANTS to ACTION_WATER_PLANT and
    ...
    private void handleActionWaterPlants(long plantId) {
        ...
        // Update only plants that are still alive, now with id
    ...
    private void handleActionUpdatePlantWidgets() {
        ...
        if (cursor != null && cursor.getCount() > 0) {
            ...
            long lastWatered = timeNow - wateredAt;
            canWater = lastWatered > PlantUtils.MIN_AGE_BETWEEN_WATER && lastWatered < PlantUtils.MAX_AGE_WITHOUT_WATER;
